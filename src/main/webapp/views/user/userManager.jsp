...
<link href="/scms/commons/jslib/hplus/css/style.min.css"
	rel="stylesheet">
<link
	href="/scms/commons/jslib/hplus/css/plugins/bootstrap-table/bootstrap-table.min.css"
	rel="stylesheet">
<link rel="stylesheet"
...
<body class="gray-bg black-bg-gmtx">
	...
	<script type="text/javascript"
		src="/scms/commons/jslib/ztreeV3.5.15/jquery.ztree.all-3.5.js"></script>

	<script src="/scms/commons/jslib/hplus/js/plugins/iCheck/icheck.min.js"
		type="text/javascript"></script>
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/bootstrap.min.js"></script>
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/plugins/sweetalert/sweetalert.min.js"></script>
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/plugins/suggest/bootstrap-suggest.min.js"></script>
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/content.min.js"></script>
	<script type="text/javascript">
		//判断为空
		...
		$(function() {
			...
			//loadUnit("/scms/manager/CommonController/getUnitList","unitId");
			//loadUnit("/scms/manager/CommonController/getUnitList","unitId_up");
			//loadUnit("/scms/manager/CommonController/getUnitList","unitId_search");

			loadRoleChk("/scms/role/getRoleList", "roleAccess");
