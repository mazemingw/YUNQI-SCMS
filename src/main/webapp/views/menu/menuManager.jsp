...
<body class="gray-bg black-bg-gmtx">
	...
	<script type="text/javascript">
		...
		function zTreeOnDrop(event, treeId, treeNodes, targetNode, moveType) {
			...
			$.ajax({
				url : '/scms/manager/ModuleController/changeJoin',
				dataType : 'json',
				data : {
					selfId : selfId,
					parentId : parentId
