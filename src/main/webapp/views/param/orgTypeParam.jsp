...
<html>
	<head>
		...
		<link href="/scms/commons/jslib/hplus/css/bootstrap.min.css" rel="stylesheet">
		<link href="/scms/commons/jslib/hplus/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
		<link href="/scms/commons/jslib/hplus/css/animate.min.css" rel="stylesheet">
		<link href="/scms/commons/jslib/hplus/css/style.min.css" rel="stylesheet">
		<link href="/scms/commons/jslib/hplus/css/plugins/bootstrap-table/bootstrap-table.min.css" rel="stylesheet">
		<link rel="stylesheet" href="/scms/commons/jslib/hplus/css/plugins/sweetalert/sweetalert.css" type="text/css"></link>
		<link rel="stylesheet" href="/scms/commons/jslib/ztreeV3.5.15/css/zTreeStyle/zTreeStyle.css" type="text/css"></link>
		...
		<script type="text/javascript" src="/scms/commons/jslib/hplus/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
		<script type="text/javascript" src="/scms/commons/jslib/hplus/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
		<script type="text/javascript" src="/scms/commons/jslib/hplus/js/bootstrap.min.js"></script>
		...
		<script type="text/javascript">
			...
			$(function(){
			    ...
			    url: "/scms/manager/ProParamInfoController_OrgType_Set/getAllOrgType",
			    dataType: "json",
			    method: 'post',
		      ...
		      function addOrgType(){
				...
				$.ajax({
					url:'/scms/manager/ProParamInfoController_OrgType_Set/addOrgType',
					type:'post',
					async:'true',
					cache:false,
			  ...
			  function delOrgType(){
		        ...
		        for(var i = 1;i<selects.length;i++){
			  	...
			  	swal({
		            ...
		            if (isConfirm) {
		                $.ajax({
							url:'/scms/manager/ProParamInfoController_OrgType_Set/delOrgType',
							type:'post',
							async:'true',
							cache:false,
			  ...
			  function edit(id,name,outside_code,sortNum){
				...
				function upOrgType(){
					...
					$.ajax({
					url:'/scms/manager/ProParamInfoController_OrgType_Set/upOrgType',
					type:'post',
					async:'true',
					cache:false,
				...
				<div class="col-sm-12">
					<div class="ibox">
						<div class="ibox-title">
							<div class="row">
								<div class="col-sm-1">
									<button class="btn btn-gmtx-define1" data-toggle="modal" href="#addwin" data-keyboard="true" data-backdrop="false" id="btn_add" onclick="Materialize.toast('这里有没修复的故障', 4000)">
										有bug
									</button>
								</div>
								<div class="col-sm-1">
