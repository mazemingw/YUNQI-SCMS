...
<html lang="en" class="no-js">
	<head>
		...
		<link href="/${appName}/commons/jslib/hplus/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
		...
		<script type="text/javascript" src="/${appName}/commons/jquery-3.1.1.min.js"></script>

		<link rel="stylesheet" href="/${appName}/commons/css/components.css" type="text/css"></link>
		...
		<div class="container" id="div1">
			...
			<div class="row margin-top-20">
				...
				<div class="col-md-6">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<i class="ssjk-icon1"></i>
							    <span class="caption-subject font-green bold uppercase">各市占比数</span>
						</div>
				...
				<div class="col-md-6">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<i class="ssjk-icon2"></i>
							    <span class="caption-subject font-green bold uppercase">全省总数</span>
						</div>
						<div class="portlet-body">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<i class="ssjk-icon3"></i>
								<span class="caption-subject font-green bold uppercase">各市已生效数</span>
						</div>
						<div class="portlet-body">
		...
		<div class="container" id="div2">
			...
			<div class="row margin-top-20">
				...
				<div class="col-md-6">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<i class="ssjk-icon4"></i>
								<span class="caption-subject font-green bold uppercase">签订比例数</span>
						</div>
						<div class="portlet-body">
				...
				<div class="col-md-6">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<i class="ssjk-icon5"></i>
								<span class="caption-subject font-green bold uppercase">市签订数</span>
						</div>
						<div class="portlet-body">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<i class="ssjk-icon6"></i>
								<span class="caption-subject font-green bold uppercase">日生效数</span>
							<span style="float: right"> 开始签字日期 
								<i class="fa fa-calendar" style="color: black;"></i> 
									<input type="text" value="" id="effectiveEndDate1"> 结束签字日期 
								<i class="fa fa-calendar" style="color: black;"></i> 
									<input type="text" value="" id="effectiveEndDate2">
