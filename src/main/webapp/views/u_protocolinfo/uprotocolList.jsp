...
<html>
	<head>
		...
		<link href="/${appName}/commons/jslib/hplus/css/font-awesome.min.css" rel="stylesheet">
	...
	<body class="gray-bg black-bg-gmtx">
		...
		<script	src="/${appName}/commons/jslib/hplus/js/plugins/layer/layer.min.js"></script>
		<script	src="/${appName}/commons/jslib/hplus/js/content.min.js"></script>
		<script	src="/${appName}/commons/jslib/hplus/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
		<script	src="/${appName}/commons/jslib/hplus/js/plugins/bootstrap-table/bootstrap-table-mobile.min.js"></script>
		<script	src="/${appName}/commons/jslib/hplus/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
