...
<link href="/scms/commons/jslib/hplus/css/bootstrap.min.css"
	rel="stylesheet">
<link href="/scms/commons/jslib/hplus/css/font-awesome.min.css?v=4.4.0"
	rel="stylesheet">
<link href="/scms/commons/jslib/hplus/css/animate.min.css"
	rel="stylesheet">
<link href="/scms/commons/jslib/hplus/css/style.min.css?v=4.0.0"
	rel="stylesheet">
<link href="/scms/commons/jslib/hplus/css/plugins/bootstrap-table/bootstrap-table.min.css"
	rel="stylesheet">


<!-- Sweet Alert -->
<link href="/scms/commons/jslib/hplus/css/plugins/sweetalert/sweetalert.css"
	rel="stylesheet">
<!-- Sweet Alert -->

<link href="/scms/commons/css/qy-style.css" rel="stylesheet">

<link href="/scms/commons/jslib/hplus/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css"
	rel="stylesheet">
...
<body class="gray-bg black-bg-gmtx">
				...
				<div class="row text-left">
					...
					<div class="row">
						...
						<div class="col-sm-2 col-md-offset-1">
							<a href="/scms/download/UnitImportFile.xls"
					...
					<div class="row">
						<form method="post" class="form-horizontal" id="upform">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label"> 单位类别 </label>
								<div class="col-sm-8 controls">
									<select class="form-control unitTypeId" name="unitTypeId" id="unitTypeId_up"></select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label"> 编码 </label>
				...
				<div class="modal-body">
					<div class="row">
						<form method="post" class="form-horizontal"
							...
							<div class="control-group">
								<div class="controls">
									<button type="submit" id="" class="btn btn-gmtx-define1 center-block">上传</button>
								</div>
							</div>
					</div>
				</div>
	...
	<script src="/scms/commons/jslib/hplus/js/jquery.min.js?v=2.1.4"></script>
	<script src="/scms/commons/jslib/hplus/js/jquery-ui-1.10.4.min.js"></script>
	...
	<script type="text/javascript" src="/scms/commons/jslib/jquery-form.js"></script>
	<script src="/scms/commons/jslib/hplus/js/bootstrap.min.js?v=3.3.5"></script>
	<script src="/scms/commons/jslib/hplus/js/content.min.js?v=1.0.0"></script>

	<!-- Sweet Alert -->
	<script type="text/javascript"
		src="/scms/commons/jslib/hplus/js/plugins/sweetalert/sweetalert.min.js"></script>
	<!-- Sweet Alert -->
	<script src="/scms/commons/jslib/hplus/js/plugins/iCheck/icheck.min.js"></script>
	<script src="/scms/commons/jslib/CommonValue.js"></script>
	<script src="/scms/commons/jslib/hplus/js/plugins/bootstrap-table/bootstrap-table.min.js"
		type="text/javascript"></script>
	<script src="/scms/commons/jslib/hplus/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"
		type="text/javascript"></script>
	<script src="/scms/commons/jslib/hplus/js/plugins/prettyfile/bootstrap-prettyfile.js"></script>
	<script>
			//验证添加表单
			...
			$(function(){
				...
				// 加载下拉框
				loadUnitType("/scms/unitinfo/getUnitTypeList","unitTypeSel");
				loadUnitGrade("/scms/unitinfo/getUnitGradeList","unitGradeSel");
				
				loadUnitType("/scms/unitinfo/getUnitTypeList","unitTypeId");
				loadUnitGrade("/scms/unitinfo/getUnitGradeList","unitGradeId");
				
				loadUnitType("/scms/unitinfo/getUnitTypeList","unitTypeId_up");
				loadUnitGrade("/scms/unitinfo/getUnitGradeList","unitGradeId_up");
				
				loadRoleChk("/scms/manager/CommonController/getRoleList","roleAccess");  //加载角色
				var $table = $('#table');
				   $table.bootstrapTable({
				    url: "/scms/unitinfo/queryUnitInfoList_table",
				    dataType: "json",
				    method: 'post',
		      ...
		      function ajaxSubmitForm() {
					...
					startProcess();
			   　　　　var option = {
			         　　		url:'/scms/manager/ProUnitinfoController/addExcel',
				         	data:{'roleIds':roles},
				        　　  type:'POST',
				         　　 dataType:'json',
