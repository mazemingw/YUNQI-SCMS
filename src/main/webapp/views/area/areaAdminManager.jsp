...
<body class="gray-bg black-bg-gmtx">
	...
	<script type="text/javascript">
		...
		function changeSheng(suffix) {
			...
			$('#shi' + suffix).val('');
			loadCity("/scms/area/getShiAreaList", "shi" + suffix, shengid);
			$('#xian' + suffix).val('');
		}
		...
		function changeShi(suffix) {
			...
			$('#xian' + suffix).val('');
			loadCity("/scms/area/getXianAreaList", "xian" + suffix, shiid);
		}
		/*---share end**/
		$(function() {
			loadCity("/scms/area/getShengAreaList", "sheng_search", null);
			loadCity("/scms/area/getShengAreaList", "sheng_add", null);
			loadCity("/scms/area/getShengAreaList", "sheng_up", null);
			$("#username_add").val('');
			$("#userpsw_add").val('');
			$("#unitId").val('');
			$("#userType").val('');
		...
		function resetPsw(userCode_resetPsw) {
			...
			swal({
				...
				if (isConfirm) {
					$.ajax({
						url : '/scms/manager/UserController/resetPsw',
						type : 'post',
						async : 'true',
						cache : false,
						data : {
