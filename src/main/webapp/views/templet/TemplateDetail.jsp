...
<html>
	...
	<head>
		...
		<link href="/${appName}/commons/jslib/hplus/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
		...
		<!-- laydate -->
		<script src="/${appName}/commons/jslib/hplus/js/plugins/layer/laydate/laydate.js"></script>
		<!-- laydate -->
					...
					<div class="ibox float-e-margins">
						<div class="ibox-content">
								...
								<div class="row">
									...
									<div class="col-sm-8 text-center">
											<label class="col-sm-12 control-label">模板编号:
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="col-sm-3">
											<label class="col-sm-12 control-label">协议类型:
									...
									<div class="col-sm-12">
										<div class="col-sm-3">
											<label class="col-sm-12 control-label">
											   <span>甲方参数(<span id="paramCount"></span>):</span>
											</label>
										</div>
										<div class="col-sm-9">
											<div id="paramFir"></div>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="col-sm-3">
											<label class="col-sm-12 control-label">
											   <span>乙方参数(<span id="paramSecCount"></span>):</span>
											</label>
										</div>
										<div class="col-sm-9">
											<div id="paramSec" ></div>
