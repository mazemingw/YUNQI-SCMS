...
<html>
	...
	<head>
		...
		<!-- ztree css -->
		<link rel="stylesheet" href="/${appName}/commons/jslib/ztreeV3.5.15/css/zTreeStyle/zTreeStyle.css" type="text/css">
		<!-- ztree css -->
		...
		<script src="/${appName}/commons/jslib/hplus/js/content.min.js?v=1.0.0"></script>
		...
		<!-- ztree js -->
		<script type="text/javascript" src="/${appName}/commons/jslib/ztreeV3.5.15/jquery.ztree.core-3.5.min.js"></script>
		<script type="text/javascript" src="/${appName}/commons/jslib/ztreeV3.5.15/jquery.ztree.excheck-3.5.min.js"></script>
		<script type="text/javascript" src="/${appName}/commons/jslib/js-gmxt-define/protocolType_radio.js"></script>
		<!-- ztree js -->

		<script type="text/javascript" src="/${appName}/commons/jslib/jquery-form.js"></script>
		<!-- Sweet Alert -->
				...
				<div class="col-sm-7 col-md-offset-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form method="post" class="form-horizontal" enctype="multipart/form-data" id="addForm">
									...
									<div class="col-sm-10">
										<div class="content_wrap">
											<div class="zTreeDemoBackground left">
												<input id="protocolTypeSel" name="protocolTypeSel" type="text" readonly value="" style="width: 120px;" onclick="showMenu();" />
												&nbsp;
												<a id="menuBtn" href="#" onclick="showMenu(); return false;" class="btn btn-gmtx-define1">选择</a>
											</div>
										</div>
								...
								<div class="form-group" id="processDiv" style="display:none;">
									<div class="col-sm-12">
										<div class="progress">
										  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="4" aria-valuemin="0" aria-valuemax="100" style="width: 80%;" id="progressContent">
										    模版上传中,请耐心等待...
										  </div>
										</div>
									</div>
