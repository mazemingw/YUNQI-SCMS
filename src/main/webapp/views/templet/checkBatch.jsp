				...
				<div class="ibox-content">
					<div class="row text-left">
						<div class="row">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control input-sm" id="unitInfoName" placeholder="机构名称或机构编号">
							</div>
							<label class="col-sm-2 control-label text-right" id="examLevelLabel">
								机构等级：
							</label>
							<div class="col-sm-3">
						...
						<div class="row">
							...
							<div class="col-sm-5">
								<button class="btn btn-gmtx-define1" type="button" onclick="javascript:loadUnitInfo();">
									搜索
								</button>
							</div>
				...
				<div class="ibox-content">
					<div class="row text-left">
						<div class="col-sm-12">
							...
							<button class="btn btn-gmtx-define1" type="button" id="addUnitBtn" onclick="javascript:downloadParamFile();">
								下载协议参数文件
							</button>
						</div>
